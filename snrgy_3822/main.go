...
import (
	...
	handler_database_init "github.com/SENERGY-Platform/mgw-module-manager/pkg/components/handler/database/migrations/init"
...
func main() {
	...
	err = databaseHdl.Migrate(ctx, handler_database_init.Migration, handler_database_restructure.Migration)
	if err != nil {
