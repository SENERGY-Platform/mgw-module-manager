...
require (
	...
	github.com/SENERGY-Platform/mgw-core-manager/client v0.6.0
	...
	github.com/SENERGY-Platform/mgw-modfile-lib v0.17.0
	github.com/SENERGY-Platform/mgw-module-lib v0.20.0
