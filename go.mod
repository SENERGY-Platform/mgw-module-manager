...
require (
	...
	github.com/SENERGY-Platform/mgw-container-engine-wrapper/client v0.5.1
	github.com/SENERGY-Platform/mgw-container-engine-wrapper/lib v0.7.1
	github.com/SENERGY-Platform/mgw-host-manager/client v0.0.2
	github.com/SENERGY-Platform/mgw-host-manager/lib v0.0.4
	github.com/SENERGY-Platform/mgw-modfile-lib v0.10.1
	...
	github.com/SENERGY-Platform/mgw-secret-manager/pkg v0.0.5
