...
func migrateAuxLabelsTab(ctx context.Context, db *sql.DB) error {
	tableName := "aux_labels"
	...
	logger.InfoContext(ctx, "renaming table", attrTable, tableName, attrNewName, "aux_dep_labels")
