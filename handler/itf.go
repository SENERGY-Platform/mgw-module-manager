...
type DepStorageHandler interface {
	...
	CreateDep(ctx context.Context, tx driver.Tx, mID, name string, timestamp time.Time) (string, error)
	...
	UpdateDep(ctx context.Context, tx driver.Tx, dID, name string, timestamp time.Time) error
