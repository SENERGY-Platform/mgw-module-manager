...
func SetRoutes(e *gin.Engine, a lib.Api) {
	...
	e.PATCH(model.DepBatchPath+"/"+model.DepStartPath, patchDeploymentsStartH(a))
	e.PATCH(model.DepBatchPath+"/"+model.DepStopPath, patchDeploymentsStopH(a))
	e.PATCH(model.DepBatchPath+"/"+model.DepRestartPath, patchDeploymentsRestartH(a))
	e.PATCH(model.DepBatchPath+"/"+model.DepDeletePath, patchDeploymentsDeleteH(a))
